...
abstract final class CampusData {
  ...
  static const List<Building> buildings = <Building>[
    ...
    Building(
        ...
        h: 7),
    Building(
        name: 'Restaurant ESP', short: 'Resto\nESP', x: 9, y: 49, w: 15, h: 7),
    ...
    Building(
        ...
        h: 6),
    Building(
        name: "Mosquée de l'ESP", short: 'Mosquée', x: 57, y: 69, w: 16, h: 6),
  ...
  static const List<PmTint> quickRouteTints = <PmTint>[
    PmTint.blue,
    PmTint.brown,
    PmTint.ochre
  ];
  ...
  static const List<String> floorLabels = <String>[
    'RDC',
    '1er étage',
    '2e étage'
  ];
  ...
  static const List<List<RoomDot>> pavillonCFloors = <List<RoomDot>>[
    <RoomDot>[
      RoomDot('C-001', 18, 26, PmTint.ochre),
      RoomDot('C-002', 34, 26, PmTint.blue),
      RoomDot('C-003', 52, 26, PmTint.blue),
      RoomDot('C-004', 70, 26, PmTint.brown),
      RoomDot('C-005', 84, 40, PmTint.ochre),
      RoomDot('C-006', 22, 74, PmTint.blue),
      RoomDot('C-007', 44, 74, PmTint.blue),
      RoomDot('C-008', 66, 74, PmTint.brown),
    ],
    <RoomDot>[
      RoomDot('C-101', 20, 26, PmTint.blue),
      RoomDot('C-102', 38, 26, PmTint.blue),
      RoomDot('C-104', 58, 26, PmTint.brown),
      RoomDot('C-105', 78, 26, PmTint.blue),
      RoomDot('C-107', 30, 74, PmTint.blue),
      RoomDot('C-108', 52, 74, PmTint.blue),
      RoomDot('C-109', 74, 74, PmTint.ochre),
    ],
    <RoomDot>[
      RoomDot('C-201', 24, 26, PmTint.blue),
      RoomDot('C-203', 46, 26, PmTint.brown),
      RoomDot('C-205', 68, 26, PmTint.blue),
      RoomDot('C-206', 34, 74, PmTint.blue),
  ...
  static const List<DirectoryGroup> directory = <DirectoryGroup>[
    DirectoryGroup('Enseignement', <DirectoryItem>[
      DirectoryItem('GI', 'Département Génie Informatique',
          '3 niveaux · 18 salles', PmTint.blue),
      DirectoryItem('GE', 'Département Génie Électrique',
          '2 niveaux · 12 salles', PmTint.blue),
      DirectoryItem(
          'GC', 'Département Génie Civil', '2 niveaux · 9 salles', PmTint.blue),
      DirectoryItem(
          'AW', 'Amphithéâtre Abdoul Aziz Wane', '204 places', PmTint.brown),
    ]),
    ...
    DirectoryGroup('Services', <DirectoryItem>[
      DirectoryItem(
          'RE', 'Restaurant ESP', 'Ouvert 11h30 — 14h30', PmTint.ochre),
      DirectoryItem(
          'BI', "Bibliothèque de l'ESP", 'Ouvert 08h — 19h', PmTint.ochre),
      DirectoryItem(
          'SE', "Secrétariat de l'ESP", 'Ouvert 08h — 16h', PmTint.ochre),
    ]),
  ];
  ...
  static const List<Place> places = <Place>[
    Place(
        code: '204',
        name: 'Salle 204',
        place: 'Génie Informatique · 1er étage',
        dist: '335 m',
        target: RouteTarget(0),
        keywords: <String>['salle 204', 'gi', 'informatique']),
    Place(
        code: '107',
        name: 'Salle C-107 (TD)',
        place: 'Pavillon C · 1er étage',
        dist: '40 m',
        target: RoomTarget(),
        keywords: <String>['salle 107', 'c-107', 'c107', 'td', 'pavillon c']),
    Place(
        code: 'LER',
        name: 'Labo LER 2.04',
        place: "Laboratoire d'Énergies Renouvelables",
        dist: '410 m',
        target: RouteTarget(2),
        keywords: <String>['salle 204', 'labo', 'laboratoire']),
    Place(
        code: 'AW',
        name: 'Amphi 204 places',
        place: 'Amphithéâtre Abdoul Aziz Wane',
        dist: '260 m',
        target: RouteTarget(1),
        keywords: <String>['amphi', 'amphithéâtre', 'salle 204', 'wane']),
    Place(
        code: 'RE',
        name: 'Restaurant ESP',
        place: 'Ouest du terrain',
        dist: '120 m',
        target: RouteTarget(1),
        keywords: <String>['resto', 'restauration', 'cantine']),
    Place(
        code: 'BI',
        name: "Bibliothèque de l'ESP",
        place: 'Aile nord · face Innodev',
        dist: '290 m',
        target: DirectoryTarget(),
        keywords: <String>['biblio', 'bibliotheque']),
    Place(
        code: 'SE',
        name: "Secrétariat de l'ESP",
        place: 'Nord du campus',
        dist: '420 m',
        target: RouteTarget(2),
        keywords: <String>['secretariat', 'administration']),
    Place(
        code: 'C',
        name: 'Pavillon C',
        place: 'Résidence · 3 niveaux',
        dist: '0 m',
        target: DirectoryTarget(),
        keywords: <String>['pavillon', 'residence']),
  ];

  static const List<Place> recents = <Place>[
    Place(
        code: '204',
        name: 'Salle 204 · Génie Informatique',
        place: '',
        dist: '',
        target: RouteTarget(0)),
    Place(
  ...
  static const List<Course> todaySchedule = <Course>[
    Course(
        ...
        who: 'M. Diop',
        room: 'Salle 204 · Génie Info',
        tint: PmTint.line),
    Course(
        time: '14h — 16h',
        title: 'TD Réseaux IP',
        who: 'Mme Ndiaye · en cours',
        room: 'Salle 204 · Génie Info',
        tint: PmTint.blue),
    Course(
        time: '16h — 18h',
        title: 'Projet DUT1 Informatique',
        who: 'Encadré',
        room: 'Salle DUT1 · Secrétariat',
        tint: PmTint.brown),
  ];
  ...
  static const List<Course> week = <Course>[
    Course(
        ...
        title: "Systèmes d'exploitation",
        who: '',
        room: 'Salle 204 · Génie Informatique',
        walk: '5 min à pied',
        tint: PmTint.brown),
    Course(
        hour: '10h15',
        duration: '1h30',
        time: '',
        title: 'Mathématiques du signal',
        who: '',
        room: 'Amphi Abdoul Aziz Wane',
        walk: '4 min à pied',
        tint: PmTint.ochre),
    Course(
        hour: '14h',
    ...
    Course(
        ...
        title: 'Projet DUT1 Informatique',
        who: '',
        room: 'Salle DUT1 · près du Secrétariat',
        walk: '6 min à pied',
        tint: PmTint.brown),
  ];
  ...
  static const List<OfflinePack> offlinePacks = <OfflinePack>[
    ...
    OfflinePack(
        'Repères AR · Génie Informatique', '7 Mo', 'En cours — 64 %', 0.64),
  ];
